...
public interface TeacherMapper {
    ...
    List<TeacherBasic> selectAllTeachers();

    List<TeacherBasic> selectAllTeachersPage(@Param("offset") int offset, @Param("rows") int rows);

    Teacher selectByEmail(@Param("email") String email);

    int updateFetchStatus(@Param("email") String email);
